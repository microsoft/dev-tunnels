...
public class TunnelStatus {
  /**
   * Gets or sets the number of hosts currently accepting connections to the
   * tunnel.
  ...
  /**
   * Gets or sets the UTC time when a host was last accepting connections to the
   * tunnel,
  ...
  /**
   * Gets or sets the UTC time when a client last connected to the tunnel, or null
   * if
