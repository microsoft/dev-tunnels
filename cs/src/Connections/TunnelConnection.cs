...
public abstract class TunnelConnection : IAsyncDisposable, IPortForwardMessageFactory
{
    ...
    /// </summary>
    protected Task ConnectTunnelSessionAsync(TunnelV1 tunnel, CancellationToken cancellation)
    {
    ...
    /// refreshes the tunnel with <see cref="ITunnelManagementClient.GetTunnelAsync(TunnelV1, TunnelRequestOptions?, CancellationToken)"/>
