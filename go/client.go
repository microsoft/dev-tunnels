...
func (c *Client) ConnectToForwardedPort(ctx context.Context, listenerIn *net.Listener, port uint16) (io.ReadWriteCloser, error) {
	rwc := new(buffer)
	...
	return io.ReadWriteCloser(rwc), awaitError(ctx, errc)
}
