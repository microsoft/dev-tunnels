...
type TunnelStatus struct {
	...
	// Gets or sets the current value and limit for the rate of Ssh Gateway connections per
	// IP Address.
	SshGatewayRateLimitPerIPAddress uint64 `json:"sshGatewayRateLimitPerIPAddress,omitempty"`
}
