...
pub struct TunnelServiceProperties {
    ...
    // to use this appid.
    service_internal_app_id: String,
...
const PROD_DNS_NAME: &str = "global.rel.tunnels.api.visualstudio.com";

// Global DNS name of the pre-production tunnel service.
const PPE_DNS_NAME: &str = "global.rel.tunnels.ppe.api.visualstudio.com";

// Global DNS name of the development tunnel service.
const DEV_DNS_NAME: &str = "global.ci.tunnels.dev.api.visualstudio.com";
...
const PROD_FIRST_PARTY_APP_ID: &str = "46da2f7e-b5ef-422a-88d4-2a7f9de6a0b2";

// First-party app ID: `Visual Studio Tunnel Service - Test`
//
// Used for authenticating AAD/MSA users, and service principals outside the AME tenant,
// in the PPE and DEV service environments.
const NON_PROD_FIRST_PARTY_APP_ID: &str = "54c45752-bacd-424a-b928-652f3eca2b18";
...
// service environment.
const PROD_THIRD_PARTY_APP_ID: &str = "ce65d243-a913-4cae-a7dd-cb52e9f77647";
...
// service environment.
const PPE_THIRD_PARTY_APP_ID: &str = "544167a6-f431-4518-aac6-2fd50071928e";
...
const DEV_THIRD_PARTY_APP_ID: &str = "a118c979-0249-44bb-8f95-eb0457127aeb";
...
// environment.
const PROD_GITHUB_APP_CLIENT_ID: &str = "Iv1.e7b89e013f801f03";
...
const NON_PROD_GITHUB_APP_CLIENT_ID: &str = "Iv1.b231c327f1eaa229";
